...
def search_record():
    ...
    button_search = tk.Button(
        search_window,
        text="Search",
        command=lambda: perform_search(entry_ride_id.get()),
    )
    button_search.pack()


def perform_search(ride_id):
    if ride_id:
...
button_update = tk.Button(button_frame, text="Update Record", command=search_record)
